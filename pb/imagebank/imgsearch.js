      ...
      function img_search(o) {
        ...
        for (var n = 0; n<img_index.length; n++) {
          ...
          if (contains(key_array, keyword.toLowerCase())) {
            ...
            img = img_splt[1];
            idx = img_splt[0];
            lic = img_index[n].l.replace(/b/, "CC-BY").replace(/n/, "Public Domain");
            ill = img_index[n].p.replace(/,/g, ", ");
            if (counter % 4 == 0 && counter != 0) {
              result_array.push("        </tr>\n        <tr>\n          <td>\n            <a href=\"https://raw.githubusercontent.com/global-asp/pb-imagebank/master/medium/" + img_index[n].i + ".jpg\"><div data-content=\"Story #" + idx + " | License: " + lic + " | " + ill + "\" class=\"image\"><img src=\"https://raw.githubusercontent.com/global-asp/pb-imagebank/master/medium/" + img_index[n].i + ".jpg\" alt=\"\" /></div></a>" + "\n       </td>");
            } else {
